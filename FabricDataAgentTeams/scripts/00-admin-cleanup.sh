...
echo -e "${BLUE}"
echo "=============================================="
echo "  Entra Admin - Cleanup Bot App Registration"
echo "  (Fabric Data Agent Teams Bot)"
echo "=============================================="
echo -e "${NC}"

# Parse arguments
APP_PREFIX="fabricagent"
FORCE=false
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo ""
            echo "Options:"
            echo "  --prefix    Prefix for app registration name (default: fabricagent)"
...
# Find app to delete (try naming conventions)
